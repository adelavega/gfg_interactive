...
PracticeBlock.prototype.Trial = function(exiTrial) {
    ...
    function reset() {
        ...
        bHeight = 10;
        vertadd = 0;
        ctx.drawImage(balloon, (canvas.width/2) - bWidth/2, ((canvas.height/2) + 100) - bHeight/2, bWidth, bHeight);
    }
    ...
    function growBalloon() {
        ...
        ctx.drawImage(balloon, (canvas.width/2) - bWidth/2, ((canvas.height/2) - bHeight/2) - vertadd , bWidth, bHeight);
