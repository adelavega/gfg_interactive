...
blocks = [
	...
	new kTrack.PracBlock "prac1", "Keep track of the last word from each category!", kTrack.stim['pracLists'][0], window.stimLength
	...
	new kTrack.PracBlock "prac2", "Keep track of the last word from each category!", kTrack.stim['pracLists'][1], window.stimLength
