...
(function() {
  var Block, InstGrid, Instruction, PracBlock, Word, all_cats, categories, clearGrid, closeGrid, fillGrid, hideButtons, keyText, real_stim, stim, stimLength, wordLength,
    ...
    function Block(condition, message, trial_structure) {
      ...
      this.words = (function() {
        ...
        for (j = 0, len = ref.length; j < len; j++) {
          word = ref[j];
          results.push(new Word(word, wordLength));
        }
        return results;
      })();
